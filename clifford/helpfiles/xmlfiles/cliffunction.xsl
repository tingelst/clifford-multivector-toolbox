...
<xsl:comment> Generated automatically from an XML file of the same name.
     Copyright: Stephen J. Sangwine and Eckhard Hitzer, 2011-2017.
</xsl:comment>
<html>
<head>
<title>
<xsl:value-of select="@name"/> :: Functions (Clifford Toolbox Function Reference)
</title>
...
<xsl:apply-templates/>
<h4>(c) 2011-2017 Stephen J. Sangwine and Eckhard Hitzer.</h4>
...
<!--$Id: cliffunction.xsl 132 2017-05-17 16:53:51Z sangwine $-->
